...
//    }
    ...
    /// 懒加载 头部
    private lazy var headerView: UserDetailHeaderView2 = {
...
extension UserDetailViewController2: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.zy_dequeueReusableCell(indexPath: indexPath) as UserDetailCell
        return cell
    }
...
extension UserDetailViewController2 {
    ...
    private func setupUI() {
        ...
        tableView.zy_registerCell(cell: UserDetailCell.self)
